...
export default function WebSocket({ Component, type, height, width }) {
	...
	const [lastChangedPixel, chglastPixel] = useState({
		x: 0,
		y: 0,
		color: -1,
	});
	...
	useEffect(() => {
		let updateRoutine = setupUpdateRoutine(screenId);
