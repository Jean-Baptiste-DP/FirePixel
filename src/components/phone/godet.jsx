...
const checkdict = {true : 'bg-green-500',false : 'bg-red-500'};
export default function Godet({onClick,color,state}) {
    ...
    if (state == true || state == false) {
        return (
            ...
            <>
            <button className={`${checkdict[state]} w-8 h-8 rounded-lg text-white font-bold text-2xl text-center active:bg-emerald-700`} onClick={onClick}/>
            </>
